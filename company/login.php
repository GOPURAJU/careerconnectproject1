...
<head>
    ...
    <title>Career Connect College-Login Page</title>
    <!-- CSS -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        <h1>College | Welcome Back</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter">Hey Buddies Welcome back to Career Connect</p>
                    </div>
